...
public class AnnotateTEDDocumentsTask {

    private static final Logger LOG = LoggerFactory.getLogger(AnnotateTEDDocumentsTask.class);

    static librAIryClient librAIryClient;

    static final String input_endpoint  = "http://librairy.linkeddata.es/solr/documents";

    static final String input_labels    = "divisions_t";
