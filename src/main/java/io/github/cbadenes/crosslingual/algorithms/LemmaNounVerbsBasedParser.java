...
public class LemmaNounVerbsBasedParser implements Parser {

    private static final Logger LOG = LoggerFactory.getLogger(LemmaNounVerbsBasedParser.class);
    private final LanguageDetector languageDetector;
    private final TextObjectFactory textObjectFactory;

    public LemmaNounVerbsBasedParser() throws IOException {
    ...
    public String parse(String text) {
        try {
            ...
            request.setFilter(Arrays.asList(PoS.NOUN, PoS.VERB, PoS.ADJECTIVE));
